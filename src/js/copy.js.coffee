...
I've made these four simple gear machines with an old construction set to illustrate a few of the ways in which we can use gears to do different jobs:
