...
/***/ function(module, exports, __webpack_require__) {
	...
	var canvasOps, coorTools, drawGear, drawGears, flatten, map, partial;

	flatten = __webpack_require__(1);

	partial = __webpack_require__(15);

	map = __webpack_require__(62);

	coorTools = __webpack_require__(151);
	...
	drawGear = function(ctx, g, parameters) {
	  var drawSeg, i, len, ref, rotate, rotation, seg;
	  rotation = parameters[0] / 3000;
	  rotate = partial(coorTools.rotate, rotation / g.ratio, g.center);
	  drawSeg = function(segment) {
	    var coor;
	    coor = map(seg.coor, rotate);
	    return ctx[canvasOps[segment.op]].apply(ctx, flatten(coor));
	  };
	  ctx.beginPath();
	...
	drawGears = function(ctx, gears, parameters) {
	  var gear, i, index, len, results;
	  ctx.clearRect(0, 0, 1000, 1000);
	  results = [];
	  for (index = i = 0, len = gears.length; i < len; index = ++i) {
	    gear = gears[index];
	    results.push(drawGear(ctx, gear, parameters));
	  }
	  return results;
	};

	module.exports = function(ctx, gears) {
	  return function(parameters) {
	    return drawGears(ctx, gears, parameters);
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createWrapper = __webpack_require__(16),
	    ...
	    replaceHolders = __webpack_require__(54),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseSetData = __webpack_require__(17),
	    ...
	    createPartialWrapper = __webpack_require__(55),
	    getData = __webpack_require__(41),
	    mergeData = __webpack_require__(56),
	    setData = __webpack_require__(49),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var identity = __webpack_require__(18),
	    metaMap = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var composeArgs = __webpack_require__(34),
	    ...
	    createRecurryWrapper = __webpack_require__(37),
	    getHolder = __webpack_require__(51),
	    reorder = __webpack_require__(52),
	    replaceHolders = __webpack_require__(54),
	    root = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLaziable = __webpack_require__(38),
	    setData = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LazyWrapper = __webpack_require__(39),
	    getData = __webpack_require__(41),
	    getFuncName = __webpack_require__(43),
	    lodash = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var metaMap = __webpack_require__(19),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var realNames = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toFinite = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(111);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(110),
	    ...
	    indexKeys = __webpack_require__(114),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseTimes = __webpack_require__(115),
	    ...
	    isArray = __webpack_require__(14),
	    isLength = __webpack_require__(12),
	    isString = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(119),
	    ...
	    WeakMap = __webpack_require__(20),
	    toSource = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isStrictComparable = __webpack_require__(124),
	    toPairs = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseToPairs = __webpack_require__(127),
	    getTag = __webpack_require__(118),
	    mapToArray = __webpack_require__(107),
	    setToPairs = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PI, cos, ct, memoize, radians, sin;

	cos = Math.cos, sin = Math.sin, PI = Math.PI;

	memoize = __webpack_require__(135);
	...
	ct.rotateMatrix = memoize(function(theta) {
	  var c, s;
	  c = cos(theta);
	  s = sin(theta);
	  return [[c, -s], [s, c]];
	...
	ct.reflectYMatrix = function() {
	  return [[1, 0], [0, -1]];
	};

	ct.vTimesM = function(v, m) {
	  return [m[0][0] * v[0] + m[0][1] * v[1], m[1][0] * v[0] + m[1][1] * v[1]];
	};

	ct.vPlusV = function(v1, v2) {
	  return [v1[0] + v2[0], v1[1] + v2[1]];
	};

	ct.vMinusV = function(v1, v2) {
	  return [v1[0] - v2[0], v1[1] - v2[1]];
	};

	ct.rotateVector = function(theta, v) {
	  return ct.vTimesM(v, ct.rotateMatrix(theta));
	};

	ct.rotate = function(theta, origin, v) {
	  return ct.vPlusV(ct.rotateVector(theta, ct.vMinusV(v, origin)), origin);
	};
